...
# this is not exported purposefully: ctypes interface is low-level,
# you are basically calling the C functions directly.
# Anyone that uses it directly should know that they are doing.
_secp256k1 = ctypes.cdll.LoadLibrary(ctypes.util.find_library('secp256k1'))
...
def _set_zkp_func_types():
    ...
    _secp256k1.secp256k1_surjectionproof_initialize.restype = ctypes.c_int
    _secp256k1.secp256k1_surjectionproof_initialize.argtypes = [
        ctypes.c_void_p,  # const secp256k1_context* ctx
    ...
    _secp256k1.secp256k1_surjectionproof_serialized_size.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
...
secp256k1_context_sign = _secp256k1.secp256k1_context_create(SECP256K1_CONTEXT_SIGN)
assert secp256k1_context_sign is not None
secp256k1_context_verify = _secp256k1.secp256k1_context_create(SECP256K1_CONTEXT_VERIFY)
...
def randomize_context(ctx):
    seed = os.urandom(32)
    assert(_secp256k1.secp256k1_context_randomize(ctx, seed) == 1)
...
if secp256k1_has_zkp:
    secp256k1_blind_context = _secp256k1.secp256k1_context_create(
